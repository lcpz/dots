...
alias awtheme='$EDITOR $HOME/.config/awesome/themes/steamburn/theme.lua'
...
alias starthome='netctl start wlp3s0-supercazzola'
alias rehome='netctl stop-all; sleep 2; netctl start wlp3s0-supercazzola'
